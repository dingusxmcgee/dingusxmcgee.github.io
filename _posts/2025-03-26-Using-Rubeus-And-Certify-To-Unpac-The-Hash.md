...
See the MS [docs] (https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-10/security/threat-protection/auditing/event-4769) for more information. 
...
```Ticket_Options=0x40800018 Forwardable, Renewable, Renewable_ok, Enc_tkt_in_skey ```
``` Ticket_Options=0x40810018 = Forwardable, Renewable, Canonicalize, Renewable_ok, Enc_tkt_in_skey```
